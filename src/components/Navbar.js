                    ...
                    <div>

                        {
                            RandomBool.isLoggedIn ? (
                                <div className=' hover:cursor-pointer transition-all duration-150 flex gap-[10px] items-center  rounded-[30px] p-[10px] px-[30px] font-bold  text-sm'><img src={userImage} className='rounded-full w-[27px] '></img>  <span className='text-lg font-semibold '>{nameOfuser}</span></div>
                            ) : (
                                RandomBool.isLogin ? (
                                    <Link to="/login">
